...
parser = argparse.ArgumentParser(description=f'Set up a VPN to {Configuration.VPN_ENDPOINT} inside the network namespace '
                                 f'{Configuration.NS_NAME}. '
...
def set_up_openfortivpn(ns_exec):
    openfortivpn.set_up(Configuration.NS_NAME, Configuration.VPN_ENDPOINT, Configuration.VPN_USER, password)
